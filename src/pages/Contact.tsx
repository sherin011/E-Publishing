          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-5 space-y-12">
              ...
              <div className="space-y-8">
                {[
                  { icon: Mail, title: "Email Us", detail: "hello@epublishpro.com", sub: "Response within 24 hours" },
                  { icon: Phone, title: "Call Us", detail: "+1 (555) 000-0000", sub: "Mon-Fri, 9am - 6pm EST" },
                  { icon: MapPin, title: "Visit Us", detail: "123 Publishing Way, Suite 100", sub: "Digital City, DC 90210" }
                ].map((item, i) => (
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="glass-card p-6 rounded-2xl flex items-center gap-4 shadow-2xl">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Digital City, DC 90210</p>
            </div>
          </div>
        </div>
      </section>
